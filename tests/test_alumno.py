...
def setup_db():
    ...
    try:
        ...
        cursor.execute("DELETE FROM alumnos WHERE correo = 'alumno.test@universidad.cl'")
        connection.commit()
...
def test_create_alumno():
    ...
    alumno_id = Alumno.create("Alumno Test", "alumno.test@universidad.cl", fecha_ingreso)
...
def test_update_alumno():
    ...
    Alumno.update(alumno_id_test, "Alumno Actualizado", "alumno.test@universidad.cl", fecha_ingreso)
