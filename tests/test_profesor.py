...
def setup_db():
    ...
    try:
        ...
        cursor.execute("DELETE FROM profesores WHERE correo = 'profesor.test@universidad.cl'")
        connection.commit()
...
def test_update_profesor():
    ...
    Profesor.update(profesor_id_test, "Profesor Actualizado", "profesor.test@universidad.cl")
