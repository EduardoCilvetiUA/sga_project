...
update_alumno = "UPDATE alumnos SET nombre = %s, correo = %s, fecha_ingreso = %s WHERE id = %s"
insert_alumno = "INSERT INTO alumnos (id, nombre, correo, fecha_ingreso) VALUES (%s, %s, %s, %s)"
...
insert_prerequisito = "INSERT INTO prerequisitos (curso_id, prerequisito_id) VALUES (%s, %s)"
...
update_instancia = "UPDATE instancias_curso SET curso_id = %s, anio = %s, periodo = %s WHERE id = %s"
insert_instancia = "INSERT INTO instancias_curso (id, curso_id, anio, periodo) VALUES (%s, %s, %s, %s)"
...
check_profesor_seccion_exists = "SELECT id FROM profesor_seccion WHERE profesor_id = %s AND seccion_id = %s"
insert_profesor_seccion = "INSERT INTO profesor_seccion (profesor_id, seccion_id) VALUES (%s, %s)"
...
check_alumno_seccion_exists = "SELECT id FROM alumno_seccion WHERE alumno_id = %s AND seccion_id = %s"
insert_alumno_seccion = "INSERT INTO alumno_seccion (alumno_id, seccion_id) VALUES (%s, %s)"
...
check_alumno_seccion_by_seccion = "SELECT id FROM alumno_seccion WHERE alumno_id = %s AND seccion_id = %s"
...
LIMIT 1 OFFSET %s
"""
check_nota_exists = "SELECT id FROM notas WHERE alumno_seccion_id = %s AND instancia_evaluacion_id = %s"
...
get_max_section_number = "SELECT MAX(numero) as max_num FROM secciones WHERE instancia_curso_id = %s"