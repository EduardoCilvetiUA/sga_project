    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                return render_template("cargas/resultados.html", resultados=resultados, tipo="alumnos")
    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                flash(f"Carga completada: {resultados['exitosos']} exitosos, {resultados['fallidos']} fallidos")
                return render_template("cargas/resultados.html", resultados=resultados, tipo="profesores")
            except Exception as e:
                flash(f"Error al procesar el archivo: {str(e)}")
                return redirect(request.url)
        else:
    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                flash(f"Carga completada: {resultados['exitosos']} exitosos, {resultados['fallidos']} fallidos")
                return render_template("cargas/resultados.html", resultados=resultados, tipo="cursos")
            except Exception as e:
                flash(f"Error al procesar el archivo: {str(e)}")
                return redirect(request.url)
        else:
    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                flash(f"Carga completada: {resultados['exitosos']} exitosos, {resultados['fallidos']} fallidos")
                return render_template("cargas/resultados.html", resultados=resultados, tipo="salas")
            except Exception as e:
                flash(f"Error al procesar el archivo: {str(e)}")
                return redirect(request.url)
        else:
    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                flash(f"Carga completada: {resultados['exitosos']} exitosos, {resultados['fallidos']} fallidos")
                return render_template("cargas/resultados.html", resultados=resultados, tipo="instancias")
            except Exception as e:
                flash(f"Error al procesar el archivo: {str(e)}")
                return redirect(request.url)
        else:
    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                flash(f"Carga completada: {resultados['exitosos']} exitosos, {resultados['fallidos']} fallidos")
                return render_template("cargas/resultados.html", resultados=resultados, tipo="secciones")
            except Exception as e:
                flash(f"Error al procesar el archivo: {str(e)}")
                return redirect(request.url)
        else:
    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                flash(f"Carga completada: {resultados['exitosos']} exitosos, {resultados['fallidos']} fallidos")
                return render_template("cargas/resultados.html", resultados=resultados, tipo="alumnos_seccion")
            except Exception as e:
                flash(f"Error al procesar el archivo: {str(e)}")
                return redirect(request.url)
        else:
    ...
    if request.method == "POST":
        ...
        if archivo and archivo.filename.endswith('.json'):
            ...
            try:
                ...
                flash(f"Carga completada: {resultados['exitosos']} exitosos, {resultados['fallidos']} fallidos")
                return render_template("cargas/resultados.html", resultados=resultados, tipo="notas")
            except Exception as e:
                flash(f"Error al procesar el archivo: {str(e)}")
                return redirect(request.url)
        else:
