...
def create():
    ...
    if request.method == 'POST':
        ...
        if 'seccion_id' in request.form and 'alumno_id' not in request.form:
        ...
        elif 'seccion_id' in request.form and 'alumno_id' in request.form and 'instancia_id' not in request.form:
        ...
        elif 'seccion_id' in request.form and 'alumno_id' in request.form and 'instancia_id' in request.form and 'nota' in request.form:
            ...
            if error is None:
                try:
                    ...
                    alumno_seccion_id = Nota.get_student_section_id(alumno_id, seccion_id)
    ...
    return render_template('notas/create.html', 
                         secciones=secciones, 
                         alumnos=alumnos, 
...
def student_grades(alumno_id, seccion_id):
    ...
    return render_template('notas/student_grades.html', 
                         alumno=alumno, 
                         seccion=seccion, 
                         notas=notas,
...
def section_grades(seccion_id):
    ...
    return render_template('notas/section_grades.html', 
                         seccion=seccion, 
                         alumnos=alumnos,
                         topicos=topicos,
